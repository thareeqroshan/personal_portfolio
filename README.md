...
```shell
git clone https://github.com/thareeqroshan/personal_portfolio
```
...
5) Build a local version of your site by executing `hugo server`. You can see the site by navigating to `http://localhost:1313/personal_portfolio/` (actual URL will be outputted in the CLI) in a browser.
...
`hugo.yaml`:
```yaml
baseURL: 'https://thareeqroshan.github.io/personal_portfolio'
title: 'Qubt Theme'
```
...
links:
  - github: https://github.com/thareeqroshan/personal_portfolio
  - link: https://github.com/thareeqroshan/personal_portfolio#readme
...
`https://thareeqroshan.github.io/personal_portfolio`